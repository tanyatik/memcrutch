...
/Users/tanyatik/cheatnotes//subdir/test_note_3.md-ПРИВЕТ"""

        search_results = list(grep_search_results_iterator(test_grep_stdout))

        self.assertEqual(search_results[0], SearchResult(filename='/Users/tanyatik/cheatnotes//test_note_1.md', markdown='\n# Paragraph three\n\nThee paragrath three recursion'))
        self.assertEqual(search_results[1], SearchResult(filename='/Users/tanyatik/cheatnotes//subdir/subdir2/test_note_4.md', markdown='This is test note with even more recursion\n'))
        self.assertEqual(search_results[2], SearchResult(filename='/Users/tanyatik/cheatnotes//subdir/test_note_3.md', markdown='LALALA\nThis is test recursive note to test recursion\n\nПРИВЕТ'))

    def test_search_notes(self):
        # TODO: create some notes and search them
        pass
